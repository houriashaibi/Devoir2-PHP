...
if (!$ch = fopen("commande.txt","r"))
	...
	echo "<table border=2 ><tr bgcolor=#808080><th> Numero de commande</th><th> Numero client </th><th>date de commande </th><th> designation article</th><th>quantite(PAl) </th><th>prix unitaire </th><th>date de livrasion </th><th>Adresse client </th></tr>";
  while(!feof($ch)) {
	  $l= fgets($ch,255);
	  $c=explode('|',$l);
	  echo "<tr>";
